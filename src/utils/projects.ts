...
export const projects: Project[] = [
  {
    ...
    imageUrl: "https://via.placeholder.com/800x600?text=StackDecision&bg=18d26e&color=fff",
  ...
  },
  {
    ...
    imageUrl: "https://via.placeholder.com/800x600?text=NPM+Package&bg=cb3837&color=fff",
  ...
  },
  {
    ...
    imageUrl: "https://via.placeholder.com/800x600?text=TabBuddy&bg=4285f4&color=fff",
